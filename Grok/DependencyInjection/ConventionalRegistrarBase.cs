...
namespace Grok.DependencyInjection
{
    ...
    {
        private readonly ILogger<ConventionalRegistrarBase> logger;
        public virtual void AddAssembly(IServiceCollection services, Assembly assembly)
        {
            var types = AssemblyHelper.GetLoadableTypes(assembly, logger);
            ...
            List<ServiceIdentifier> allExposingKeyedServiceTypes)
        {
            ...
            return allExposingKeyedServiceTypes.FirstOrDefault(
                t => t.ServiceType != exposingServiceType && exposingServiceType.IsAssignableFrom(t.ServiceType)).ServiceType;
        }
